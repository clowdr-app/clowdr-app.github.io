    ...
    <>
      ...
      <Layout>
        <Container my={8}>
          ...
          <p>Welcome to Clowdr’s privacy policy.</p>
          <p>
          ...
          <p>Email address: hello@clowdr.org</p>
          <p>
          ...
          <ul>
            ...
            <li>subscribe to any other service or publication we offer; </li>
          ...
          <p>We do not use:</p>
          <p>Analytical or performance cookies, or</p>
          <p>Functionality cookies, or</p>
